...
export const metadata = {
  title: "روان افزار | پرسشنامه شخصيتى شحصیتی چند وجهی مینه سوتا",
  description: "پرسشنامه شخصيتى شحصیتی چند وجهی مینه سوتا",
};
    ...
    <section className="flex flex-col  mx-auto lg:max-w-[90%] pt-8 gap-8 lg:gap-16 lg:flex-row lg:justify-between">
      <aside className="w-[90vw] mx-auto lg:w-1/4 flex flex-col items-center p-4 lg:h-screen lg:max-h-[480px] rounded-lg shadow text-center">
        <img
          src="/img/mmpi2.jpg"
          alt=""
          className="w-[90%] my-4 max-w-[150px] h-[150px] mx-auto"
        />
        <h2>Minnesota Multiphasic Personality Inventory-2 (MMPI-2)</h2>
        <h3> پرسشنامه شحصیتی چند وجهی مینه سوتا-2</h3>
      ...
      <div className="w-[90vw] mx-auto lg:w-3/4 p-8 lg:p-12 h-screen max-h-[480px] rounded-lg shadow">
        <h1 className="font-semibold text-3xl pb-2 border-b-[1px]">
          پرسشنامه شحصیتی چند وجهی مینه سوتا-2
        </h1>
        <ul>
          <h3 className="text-2xl py-4">ویژگی های اختصاصی:</h3>
          <li className="list-disc"> رهنمودهای تفسیری </li>
          <li className="list-disc">مقیاسهای 7 گانه اعتبار سنجی </li>
          <li className="list-disc">
            محاسبه تمام مقیاسها به همراه نمودار و تفسیر
          </li>
          <li className="list-disc">همبسته های درجه اول و دوم درمان</li>
          <li className="list-disc"> طرح درمانی</li>
        </ul>
