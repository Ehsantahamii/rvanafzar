...
export const metadata = {
  title: "روان افزار | پرسشنامه هوش هیجانی",
  description: " پرسشنامه هوش هیجانی",
};
  ...
  return (
    <section className="flex flex-col  mx-auto lg:max-w-[90%] pt-8 gap-8 lg:gap-16 lg:flex-row lg:justify-between">
      <aside className="w-[90vw] mx-auto lg:w-1/4 flex flex-col items-center p-4 lg:h-screen lg:max-h-[480px] rounded-lg shadow text-center">
        ...
        />
        <h2>Emotional Quotient Inventory (EQI)</h2>
        <h3>پرسشنامه هوش هیجانی</h3>
      ...
      <div className="w-[90vw] mx-auto lg:w-3/4 p-8 lg:p-12 h-screen max-h-[480px] rounded-lg shadow">
        ...
        <ul>
          ...
          <li className="list-disc">	گزارش فردی و تجمعی (بر اساس سن، جنسیت و گروه)</li>
          <li className="list-disc">	نمودار برای مقیاس کلی، مقیاسهای ترکیبی و فرعی</li>
          <li className="list-disc"> 	10 صفحه گزارش تفسیری از تمام مقیاسها به اضافه راهبردهای بهبود</li>
        </ul>
