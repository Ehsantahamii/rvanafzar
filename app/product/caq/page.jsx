...
export const metadata = {
  title: "روان افزار | پرسشنامه تحلیل بالینی",
  description: "پرسشنامه تحلیل بالینی",
};
      ...
      <div className="w-[90vw] mx-auto lg:w-3/4 p-8 lg:p-12 h-screen max-h-[480px] rounded-lg shadow">
        ...
        <ul>
          ...
          <li className="list-disc">
            ...
            دارای 28 مقیاس (ترکیبی از مقیاسهای بالینی و شخصیتی(16 عامل کتل))
          </li>
          <li className="list-disc">مناسب برای مراکز مشاوره </li>
        </ul>
