            ...
            >
                <SwiperSlide>
                    <div className="bg-gradient-green-to-darkblue-color text-white w-full px-8 rounded-2xl flex flex-col">
                        <div className="flex flex-col md:flex-row w-[80%] mx-auto md:justify-between mt-[5%] mb-8">
                        ...
                        <div className="flex flex-col justify-center md:flex-row md:justify-around">
                            <ul className="text-right list-disc">
                                <h3 className="text-[20px] md:text-[32px] py-4 text-right">
                                    ویژگی‌های اختصاصی :
                                </h3>
                            ...
                            <div>
                                <img src="/img/soft logo.png" alt="logo" className="w-[200px] h-[200px] md:w-[300px] md:h-[300px] mx-auto" />
                            </div>

                        </div>
                        <div className="flex justify-end w-full py-16 ">
                ...
                <SwiperSlide>
                    <div className="bg-gradient-green-to-darkblue-color text-white w-full px-8 rounded-2xl flex flex-col">
                        ...
                        <div className="flex flex-col justify-center md:flex-row md:justify-around">
                            <ul className="text-right list-disc">
                                <h3 className="text-[20px] md:text-[32px] md:py-4 text-right">
                                    ویژگی‌های اختصاصی :
                                </h3>
                                <li className="text-[1rem] md:text-[24px]">
                                    جدول نمرات و نمودار برای ۵ مقیاس اصلی و مقیاس‌های فرعی
                        ...
                        <div className="flex justify-center md:justify-end w-full md:py-16">
                            <div className="flex flex-col text-base md:text-[24px] items-center">
                                جهت خرید و یا اطلاعات بیشتر کلیک کنید
                                <button className="btn w-[150px] md:w-[250px] rounded-xl px-4 py-3 md:my-4 text-[#000] bg-white">
                                    جزئیات بیشتر
                                </button>
                            </div>
                        </div>
